...
(gtk_accel_path "<Actions>/terminal-window/search-next" "<Alt>F3")
(gtk_accel_path "<Actions>/terminal-window/search-prev" "<Shift><Alt>F3")
...
(gtk_accel_path "<Actions>/terminal-window/terminal-menu" "<Primary><Shift>m")
